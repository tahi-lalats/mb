...
if (message.channel.type === 'dm') return;
    ...
    .addField("People Use This Bot", `${client.users.size}`, true)
    ...
    .addField("Created Date", `${moment.utc(client.createdAt).format("dddd, MMMM Do YYYY, HH:mm:ss")}`, false)
    ...
    .setFooter(`©MasterBot V0.4.4`,`https://cdn.discordapp.com/avatars/464511870993432578/30a3f8c3f24bf6c066c4cee279626bb5.png?size=2048`)
